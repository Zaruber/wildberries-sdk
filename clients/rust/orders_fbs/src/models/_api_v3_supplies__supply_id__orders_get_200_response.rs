...
pub struct ApiV3SuppliesSupplyIdOrdersGet200Response {
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::SupplyOrder>>,
}

impl ApiV3SuppliesSupplyIdOrdersGet200Response {
    pub fn new() -> ApiV3SuppliesSupplyIdOrdersGet200Response {
