...
pub struct ApiV1AnalyticsIncorrectAttachmentsGet200Response {
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::ApiV1AnalyticsIncorrectAttachmentsGet200ResponseReportInner>>,
}

impl ApiV1AnalyticsIncorrectAttachmentsGet200Response {
    pub fn new() -> ApiV1AnalyticsIncorrectAttachmentsGet200Response {
