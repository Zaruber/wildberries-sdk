...
#[serde(untagged)]
pub enum ApiV1AnalyticsWarehouseMeasurementsGet200Response {
    Penalty(Box<models::Penalty>),
    Measurement(Box<models::Measurement>),
}

impl Default for ApiV1AnalyticsWarehouseMeasurementsGet200Response {
    fn default() -> Self {
