...
pub struct ApiV1AnalyticsIncorrectAttachmentsGet200ResponseReportInner {
    /// Цена, ₽
    ...
    /// Причина удержания
    #[serde(rename = "lostReason", skip_serializing_if = "Option::is_none")]
...
impl ApiV1AnalyticsIncorrectAttachmentsGet200ResponseReportInner {
    pub fn new() -> ApiV1AnalyticsIncorrectAttachmentsGet200ResponseReportInner {
