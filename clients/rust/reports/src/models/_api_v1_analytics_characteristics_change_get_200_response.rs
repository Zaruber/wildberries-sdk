...
pub struct ApiV1AnalyticsCharacteristicsChangeGet200Response {
    #[serde(rename = "report", skip_serializing_if = "Option::is_none")]
    pub report: Option<Vec<models::ApiV1AnalyticsCharacteristicsChangeGet200ResponseReportInner>>,
}

impl ApiV1AnalyticsCharacteristicsChangeGet200Response {
    pub fn new() -> ApiV1AnalyticsCharacteristicsChangeGet200Response {
