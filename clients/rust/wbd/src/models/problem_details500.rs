...
pub struct ProblemDetails500 {
    ...
    pub errors: Option<Vec<models::ProblemDetails500>>,
...
impl ProblemDetails500 {
    pub fn new(title: String, request_id: String) -> ProblemDetails500 {
        ProblemDetails500 {
            status: None,
            title,
            code: None,
