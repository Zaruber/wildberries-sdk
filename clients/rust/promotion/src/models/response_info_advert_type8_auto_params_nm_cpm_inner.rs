...
pub struct ResponseInfoAdvertType8AutoParamsNmCpmInner {
    /// Артикул WB
...
impl ResponseInfoAdvertType8AutoParamsNmCpmInner {
    pub fn new() -> ResponseInfoAdvertType8AutoParamsNmCpmInner {
