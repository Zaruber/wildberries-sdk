...
pub struct AdvV0BidsPatchRequest {
    #[serde(rename = "bids")]
    pub bids: Vec<models::V0AdvertMultibid>,
}

impl AdvV0BidsPatchRequest {
    pub fn new(bids: Vec<models::V0AdvertMultibid>) -> AdvV0BidsPatchRequest {
