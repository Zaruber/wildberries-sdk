...
pub struct AdvV0BidsMinPost200ResponseBidsInner {
    /// Список ставок по местам размещения
    #[serde(rename = "bids")]
    pub bids: Vec<models::AdvV0BidsMinPost200ResponseBidsInnerBidsInner>,
    /// Артикул WB
    #[serde(rename = "nm_id")]
    pub nm_id: i64,
}

impl AdvV0BidsMinPost200ResponseBidsInner {
    pub fn new(bids: Vec<models::AdvV0BidsMinPost200ResponseBidsInnerBidsInner>, nm_id: i64) -> AdvV0BidsMinPost200ResponseBidsInner {
