...
pub struct AdvV0AuctionBidsPatch200ResponseBidsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    /// Ставки
    #[serde(rename = "nm_bids")]
    pub nm_bids: Vec<models::AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner>,
}

impl AdvV0AuctionBidsPatch200ResponseBidsInner {
    pub fn new(advert_id: i64, nm_bids: Vec<models::AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner>) -> AdvV0AuctionBidsPatch200ResponseBidsInner {
