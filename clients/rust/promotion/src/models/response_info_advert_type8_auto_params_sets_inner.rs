...
pub struct ResponseInfoAdvertType8AutoParamsSetsInner {
    /// ID set
...
impl ResponseInfoAdvertType8AutoParamsSetsInner {
    pub fn new() -> ResponseInfoAdvertType8AutoParamsSetsInner {
