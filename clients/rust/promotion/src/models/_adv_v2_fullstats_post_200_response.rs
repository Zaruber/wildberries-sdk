...
#[serde(untagged)]
pub enum AdvV2FullstatsPost200Response {
    /// Ответ при запросе с dates
    ResponseWithDate(Vec<models::ResponseWithDateInner>),
    /// Ответ при запросе с interval
    ResponseWithInterval(Vec<models::ResponseWithIntervalInner>),
}

impl Default for AdvV2FullstatsPost200Response {
    fn default() -> Self {
        Self::ResponseWithDate(Default::default())
    }
}
