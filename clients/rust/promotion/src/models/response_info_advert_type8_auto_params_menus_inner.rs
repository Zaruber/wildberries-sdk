...
pub struct ResponseInfoAdvertType8AutoParamsMenusInner {
    /// ID меню
...
impl ResponseInfoAdvertType8AutoParamsMenusInner {
    /// Меню, где размещается кампания
    pub fn new() -> ResponseInfoAdvertType8AutoParamsMenusInner {
