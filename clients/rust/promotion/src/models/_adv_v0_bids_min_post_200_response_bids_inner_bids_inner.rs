...
pub struct AdvV0BidsMinPost200ResponseBidsInnerBidsInner {
    #[serde(rename = "type")]
...
impl AdvV0BidsMinPost200ResponseBidsInnerBidsInner {
    pub fn new(r#type: models::PlacementType, value: i32) -> AdvV0BidsMinPost200ResponseBidsInnerBidsInner {
