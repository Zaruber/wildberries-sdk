...
pub struct AdvV1StatWordsGet200ResponseWordsKeywordsInner {
    /// Ключевая фраза
...
impl AdvV1StatWordsGet200ResponseWordsKeywordsInner {
    pub fn new() -> AdvV1StatWordsGet200ResponseWordsKeywordsInner {
