...
pub struct AdvV0AuctionBidsPatchRequest {
    /// Ставки в кампаниях
    #[serde(rename = "bids")]
    pub bids: Vec<models::AdvV0AuctionBidsPatchRequestBidsInner>,
}

impl AdvV0AuctionBidsPatchRequest {
    pub fn new(bids: Vec<models::AdvV0AuctionBidsPatchRequestBidsInner>) -> AdvV0AuctionBidsPatchRequest {
