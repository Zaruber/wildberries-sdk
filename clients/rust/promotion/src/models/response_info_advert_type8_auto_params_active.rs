...
pub struct ResponseInfoAdvertType8AutoParamsActive {
    ...
    #[serde(rename = "recom", skip_serializing_if = "Option::is_none")]
    pub recom: Option<bool>,
    /// Ручная ставка   - `false` — отключено   - `true` — включено 
    #[serde(rename = "booster", skip_serializing_if = "Option::is_none")]
    pub booster: Option<bool>,
}

impl ResponseInfoAdvertType8AutoParamsActive {
    /// Места размещения
    pub fn new() -> ResponseInfoAdvertType8AutoParamsActive {
