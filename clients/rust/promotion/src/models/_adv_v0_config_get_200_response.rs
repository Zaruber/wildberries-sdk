...
pub struct AdvV0ConfigGet200Response {
    /// Список категорий товаров (предметов) с минимально допустимыми ставками
    #[serde(rename = "categories", skip_serializing_if = "Option::is_none")]
    pub categories: Option<Vec<models::V0GetConfigCategoriesResponse>>,
    /// Список основных параметров конфигурации с допустимыми значениями
    #[serde(rename = "config", skip_serializing_if = "Option::is_none")]
    pub config: Option<Vec<models::AdvV0ConfigGet200ResponseConfigInner>>,
}

impl AdvV0ConfigGet200Response {
    pub fn new() -> AdvV0ConfigGet200Response {
