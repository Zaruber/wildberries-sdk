...
pub struct AuctionAdvertNmsSettings {
    #[serde(rename = "bids")]
    pub bids: Box<models::AuctionAdvertBids>,
    #[serde(rename = "subject")]
    pub subject: Box<models::AuctionAdvertSubject>,
    /// Артикул WB
    #[serde(rename = "nm_id")]
    pub nm_id: i64,
}

impl AuctionAdvertNmsSettings {
    pub fn new(bids: models::AuctionAdvertBids, subject: models::AuctionAdvertSubject, nm_id: i64) -> AuctionAdvertNmsSettings {
