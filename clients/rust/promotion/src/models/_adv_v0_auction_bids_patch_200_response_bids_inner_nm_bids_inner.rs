...
pub struct AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner {
    /// Артикул WB
    #[serde(rename = "nm_id")]
    pub nm_id: i64,
    /// Ставка
...
impl AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner {
    pub fn new(nm_id: i64, bid: i64, placement: String) -> AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner {
