...
pub struct ResponseWithIntervalInner {
    #[serde(rename = "interval", skip_serializing_if = "Option::is_none")]
    pub interval: Option<Box<models::ResponseWithIntervalInnerInterval>>,
...
impl ResponseWithIntervalInner {
    pub fn new() -> ResponseWithIntervalInner {
