...
pub struct AdvV1StatWordsGet200Response {
    #[serde(rename = "words", skip_serializing_if = "Option::is_none")]
    pub words: Option<Box<models::AdvV1StatWordsGet200ResponseWords>>,
    ...
    pub stat: Option<Vec<models::AdvV1StatWordsGet200ResponseStatInner>>,
}

impl AdvV1StatWordsGet200Response {
    pub fn new() -> AdvV1StatWordsGet200Response {
