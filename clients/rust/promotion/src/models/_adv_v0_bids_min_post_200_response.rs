...
pub struct AdvV0BidsMinPost200Response {
    /// Список карточек товаров со ставками
    #[serde(rename = "bids")]
    pub bids: Vec<models::AdvV0BidsMinPost200ResponseBidsInner>,
}

impl AdvV0BidsMinPost200Response {
    pub fn new(bids: Vec<models::AdvV0BidsMinPost200ResponseBidsInner>) -> AdvV0BidsMinPost200Response {
