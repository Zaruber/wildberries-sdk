...
pub struct V0AdvertMultibid {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i32,
    /// Артикулы WB и ставки для них
    #[serde(rename = "nm_bids")]
    pub nm_bids: Vec<models::V0AdvertMultiBidItem>,
}

impl V0AdvertMultibid {
    pub fn new(advert_id: i32, nm_bids: Vec<models::V0AdvertMultiBidItem>) -> V0AdvertMultibid {
        V0AdvertMultibid {
            advert_id,
            nm_bids,
        }
