...
pub struct V0KeywordsStatistics {
    /// Дата
    #[serde(rename = "date")]
    pub date: String,
    #[serde(rename = "stats")]
    pub stats: Vec<models::V0KeywordsStatistic>,
}

impl V0KeywordsStatistics {
    pub fn new(date: String, stats: Vec<models::V0KeywordsStatistic>) -> V0KeywordsStatistics {
