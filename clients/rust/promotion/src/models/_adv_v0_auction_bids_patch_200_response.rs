...
pub struct AdvV0AuctionBidsPatch200Response {
    /// Ставки кампании
    #[serde(rename = "bids")]
    pub bids: Vec<models::AdvV0AuctionBidsPatch200ResponseBidsInner>,
}

impl AdvV0AuctionBidsPatch200Response {
    pub fn new(bids: Vec<models::AdvV0AuctionBidsPatch200ResponseBidsInner>) -> AdvV0AuctionBidsPatch200Response {
