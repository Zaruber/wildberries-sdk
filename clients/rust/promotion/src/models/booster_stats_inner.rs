...
pub struct BoosterStatsInner {
    ...
    #[serde(rename = "avg_position", skip_serializing_if = "Option::is_none")]
    pub avg_position: Option<i32>,
}

impl BoosterStatsInner {
    pub fn new() -> BoosterStatsInner {
        BoosterStatsInner {
            date: None,
            nm: None,
            avg_position: None,
