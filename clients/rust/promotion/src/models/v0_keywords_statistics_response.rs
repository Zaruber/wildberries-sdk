...
pub struct V0KeywordsStatisticsResponse {
    #[serde(rename = "keywords")]
    pub keywords: Vec<models::V0KeywordsStatistics>,
}

impl V0KeywordsStatisticsResponse {
    pub fn new(keywords: Vec<models::V0KeywordsStatistics>) -> V0KeywordsStatisticsResponse {
