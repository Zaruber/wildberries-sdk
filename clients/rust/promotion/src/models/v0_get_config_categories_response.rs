...
pub struct V0GetConfigCategoriesResponse {
    /// ID категории товара
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "cpm_min")]
    pub cpm_min: i32,
}

impl V0GetConfigCategoriesResponse {
    pub fn new(id: i32, name: String, cpm_min: i32) -> V0GetConfigCategoriesResponse {
