...
pub struct AdvV0AuctionBidsPatchRequestBidsInner {
    /// ID кампании
    #[serde(rename = "advert_id")]
    pub advert_id: i64,
    /// Ставки
    #[serde(rename = "nm_bids")]
    pub nm_bids: Vec<models::AdvV0AuctionBidsPatchRequestBidsInnerNmBidsInner>,
}

impl AdvV0AuctionBidsPatchRequestBidsInner {
    pub fn new(advert_id: i64, nm_bids: Vec<models::AdvV0AuctionBidsPatchRequestBidsInnerNmBidsInner>) -> AdvV0AuctionBidsPatchRequestBidsInner {
