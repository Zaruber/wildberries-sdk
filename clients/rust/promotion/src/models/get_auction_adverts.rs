...
pub struct GetAuctionAdverts {
    /// Кампании
    #[serde(rename = "adverts")]
    pub adverts: Vec<models::GetAuctionAdvertsAdvertsInner>,
}

impl GetAuctionAdverts {
    pub fn new(adverts: Vec<models::GetAuctionAdvertsAdvertsInner>) -> GetAuctionAdverts {
        GetAuctionAdverts {
            adverts,
        }
    }
