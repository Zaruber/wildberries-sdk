...
pub struct ApiV3DbsOrdersOrderIdMetaUinPutRequest {
    /// УИН
    #[serde(rename = "uin")]
    pub uin: String,
}

impl ApiV3DbsOrdersOrderIdMetaUinPutRequest {
    pub fn new(uin: String) -> ApiV3DbsOrdersOrderIdMetaUinPutRequest {
