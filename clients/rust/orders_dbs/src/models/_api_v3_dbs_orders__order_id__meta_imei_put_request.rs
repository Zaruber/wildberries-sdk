...
pub struct ApiV3DbsOrdersOrderIdMetaImeiPutRequest {
    /// IMEI
    #[serde(rename = "imei")]
    pub imei: String,
}

impl ApiV3DbsOrdersOrderIdMetaImeiPutRequest {
    pub fn new(imei: String) -> ApiV3DbsOrdersOrderIdMetaImeiPutRequest {
