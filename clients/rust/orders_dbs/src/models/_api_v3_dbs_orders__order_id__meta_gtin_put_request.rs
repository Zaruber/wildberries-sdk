...
pub struct ApiV3DbsOrdersOrderIdMetaGtinPutRequest {
    /// GTIN
    #[serde(rename = "gtin")]
    pub gtin: String,
}

impl ApiV3DbsOrdersOrderIdMetaGtinPutRequest {
    pub fn new(gtin: String) -> ApiV3DbsOrdersOrderIdMetaGtinPutRequest {
