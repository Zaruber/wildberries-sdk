...
pub struct ApiV3DbsOrdersStatusPost200Response {
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::ApiV3DbsOrdersStatusPost200ResponseOrdersInner>>,
}

impl ApiV3DbsOrdersStatusPost200Response {
    pub fn new() -> ApiV3DbsOrdersStatusPost200Response {
