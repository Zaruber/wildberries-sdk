...
pub struct ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequest {
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequestOrdersInner>>,
}

impl ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequest {
    pub fn new() -> ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequest {
