...
func (o *StatisticsComparison) GetTimeToReadyDynamic() StatisticTimeToReady {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *StatisticsComparison) GetTimeToReadyDynamicOk() (*StatisticTimeToReady, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *StatisticsComparison) SetTimeToReadyDynamic(v StatisticTimeToReady) {
