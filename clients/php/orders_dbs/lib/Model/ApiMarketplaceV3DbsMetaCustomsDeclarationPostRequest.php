 ...
 */
class ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_marketplace_v3_dbs_meta_customs_declaration_post_request';
    ...
    */
    ...
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequest., number of items must be less than or equal to 1000.');
        }
