...
/**
 * ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequestOrdersInner Class Doc Comment
 *
 * @category Class
 * @package  Wildberries\Sdk\OrdersDbs
 * @author   OpenAPI Generator team
 ...
 */
class ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequestOrdersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_marketplace_v3_dbs_meta_customs_declaration_post_request_orders_inner';
    ...
    */
    ...
    public function setCustomsDeclaration($customs_declaration)
    {
        ...
        if ((mb_strlen($customs_declaration) > 29)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequestOrdersInner., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($customs_declaration) < 17)) {
            throw new \InvalidArgumentException('invalid length for $customs_declaration when calling ApiMarketplaceV3DbsMetaCustomsDeclarationPostRequestOrdersInner., must be bigger than or equal to 17.');
        }
